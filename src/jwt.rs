...
/// Decrypt and verify a given jwe to extract the contained attributes, and
/// validate the inner jws with the given base time
pub fn decrypt_and_verify_auth_result_with_base_time(
    jwe: &str,
    ...
    validator.set_base_time(base_time);
    ...
    let attributes = decoded_jws.claim("attributes");
...
pub fn decrypt_and_verify_auth_result(
    ...
    decrypt_and_verify_auth_result_with_base_time(
        jwe,
        validator,
        decrypter,
